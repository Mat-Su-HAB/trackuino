 ...
 * starts at the index where the previous one left off. By changing the stride
 * of the index (phase_delta) we get 1200 or 2200 Hz. The PHASE_DELTA_XXXX
...
extern const uint8_t afsk_sine_table[512] PROGMEM = {127,
	129,
	130,
	132,
	133,
...
// extern const uint32_t PLAYBACK_RATE    = MODEM_CLOCK_RATE / 510;  // Phase
// correct PWM
...
void afsk_timer_setup() {
	...
	// This allows 256 cycles per sample and gives 16M/256 = 62.5 KHz PWM
	// rate
	...
	// This allows 510 cycles per sample and gives 16M/510 = ~31.4 KHz PWM
	// rate
	...
	TCCR2A = (TCCR2A | _BV(COM2A1))
		 & ~(_BV(COM2A0) | _BV(COM2B1) | _BV(COM2B0));
	#endif
	...
	TCCR2A = (TCCR2A | _BV(COM2B1))
		 & ~(_BV(COM2B0) | _BV(COM2A1) | _BV(COM2A0));
	#endif
